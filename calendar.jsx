...
function main(){
var dlg =
"dialog{text:'Interfaz del Script:',bounds:[100,100,470,220],"+
"panel0:Panel{bounds:[10,10,360,110] , text:'' ,properties:{borderStyle:'etched',su1PanelCoordinates:true},"+
"statictext0:StaticText{bounds:[120,10,240,30] , text:'Crear calendario' ,properties:{scrolling:undefined,multiline:undefined}},"+
...
function validate(){
	if (isNaN(win.panel0.year.text)) return "El año debe de ser en numeros"; 
	if (win.panel0.year.text.length != 4) return "El año debe de ser de cuatro numeros";
	if (parseInt(win.panel0.year.text) < 1800 || parseInt(win.panel0.year.text) > 3000) return "El año debe de ser entre 1800 y 3000";
		return true;
	}
}
